...
function gui_addArea(id) {
	...
	temp+= '<input type="text" name="img_href" class="img_href noshow" value="">';
	temp+= '<input type="text" name="img_alt" class="img_alt noshow" value="">';
	temp+= '<select name="img_target" class="img_target noshow">';
...
function gui_htmlChanged(str) {
    ...
    else if (out == "justcoords") {
      document.getElementById("html_container").value = output_justcoords();
    }
		else {
